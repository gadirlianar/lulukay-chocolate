...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg transition-transform duration-300 group whatsapp-pulse whatsapp-ring-effect"
      aria-label="WhatsApp"
    >
      <svg
        viewBox="0 0 24 24"
